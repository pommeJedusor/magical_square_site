...
export default async function Page({ params }: { params: { lang: string } }) {
  if (params.lang == "fr") {
    ...
    return (
      <div>
        <NavLayout lang={params.lang} />
        <h1 className="text-light-grey text-center text-4xl my-5">The rules</h1>
        <h2 className="text-light-grey w-10/12 lg:w-4/12 mx-auto text-3xl my-5">Grid Setup</h2>
        <ul className="w-10/12 lg:w-4/12 mx-auto list-disc text-xl text-dark-white">
          <li className="my-2">
        ...
        <h2 className="text-light-grey w-10/12 lg:w-4/12 mx-auto text-3xl my-5">Placing Numbers</h2>
        <ul className="w-10/12 lg:w-4/12 mx-auto list-disc text-xl text-dark-white">
          <li className="my-2">
        ...
        <h2 className="text-light-grey w-10/12 lg:w-4/12 mx-auto text-3xl my-5">Winning and Losing</h2>
        <ul className="w-10/12 lg:w-4/12 mx-auto list-disc text-xl text-dark-white">
          <li className="my-2">
