  ...
  if (params.lang == "fr") {
    ...
    return (
      <div>
        ...
        <h2 className="text-dark-white w-4/12 mx-auto text-3xl my-5">Algorithme de résolution</h2>
        <p className="w-4/12 mx-auto text-xl">
          ...
          Si les récursives, les tables de transpositions et les opérations binaires ne vous font pas peur, voici <Link target="_blank" href="https://github.com/pommeJedusor/magical_square" className="text-dark-white hover:text-white hover:underline">le code</Link>
        </p>
        <h2 className="text-dark-white w-4/12 mx-auto text-3xl my-5">Le site</h2>
        <p className="w-4/12 mx-auto text-xl">
          J'ai codé ce site en utilisant react, next.js, typescript et tailwindcss.
          si vous voulez le voir, voici <Link target="_blank" href="https://github.com/pommeJedusor/magical_square_site" className="text-dark-white hover:text-white hover:underline">le code</Link>
        </p>
      </div>
    );
  } else {
