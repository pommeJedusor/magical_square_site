  ...
  return (
    <div>
      ...
      <p className="w-10/12 md:w-4/12 mx-auto text-xl text-dark-white">
        I coded a complex python algorithm that can find 33 938 944 solutions in only some seconds.
        If recursives, transposition tables and binary operations don't scare you, here is <Link target="_blank" href="https://github.com/pommeJedusor/magical_square_api" className="text-light-grey hover:text-white hover:underline">the code</Link>
      </p>
