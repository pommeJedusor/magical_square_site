...
export default function NavLayout({ lang }: { lang: string }) {
  const urls = lang == "fr" ? [{ "url": "/", "text": "Jouer" }, { "url": "/rules", "text": "Règles" }, { "url": "/solutions", "text": "Voir Les Solutions" }, { "url": "/infos", "text": "À Propos" }] : [{ "url": "/", "text": "Play" }, { "url": "/rules", "text": "Rules" }, { "url": "/solutions", "text": "See Solutions" }, { "url": "/infos", "text": "About" }];
